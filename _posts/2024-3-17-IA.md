...
Afinal, quase tudo na computação é composto por IFs no seu nível mais baixo. Mas tem outra coisa:
...
- Darwin: O *Homo Sapiens* é mais uma espécie, tão desimportante quanto as demais.
...
Sei lá? nada. Não existe **nada** de especial que *deveríamos* estar fazendo além de comer, dormir, nos hidratar e fazer exercício físico. Mesmo isso é opcional, são atribuições de quem pretende se manter vivo. Nossa existência não tem um propósito específico, muito menos um propósito grandioso.
...
Preocupações **filosóficas** com a "IA" eu não tenho nenhuma. Pelo contrário: acho muito positivo que os avanços trazidos por ela estejam colaborando para "destronar" a nossa espécie de um pedestal que atribuímos a nós mesmos, de uma posição de importância no *Grande Esquema das Coisas* que nós nunca realmente ocupamos, só porque ainda nos submetemos aos ensinamentos de alguns livros de fantasia e contos-de-fada escritos há 2000 anos atrás pra suprir os nossos próprios desejos egoicos.
