...
import { convertLatexToMarkdown } from '@/lib/latex-parser';
...
export default async function Home() {
  ...
  // Fetch ATS-format resume from the Resume repo
  const resumeExperienceUrl =
    'https://raw.githubusercontent.com/marceloprates/Resume/master/src/generated/ats__ai.tex';
  let resumeLatex = '';
  try {
    const res = await fetch(resumeExperienceUrl, { next: { revalidate: 60 * 60 } });
    resumeLatex = res.ok ? await res.text() : '';
  } catch {
    resumeLatex = '';
  }
  ...
  return (
    <div className="min-h-screen transition-colors">
      ...
      <main className="px-4 py-16 mx-auto max-w-7xl">
        ...
        <section id="projects" className="mt-10 mb-24">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            {(() => {
              ...
              const projectImageSrc = (meta: Record<string, unknown>, slug: string): string | undefined => {
                ...
                const fromExcerpt = (excerpt?: string) => {
                  const m = typeof excerpt === 'string' ? excerpt.match(/src=["']([^"']+)["']/i) : null;
        ...
        {/* Resume: ATS format LaTeX rendered as Markdown */}
            ...
            <div className="w-full bg-white ring-1 ring-black/5 rounded-md overflow-hidden">
              <div className="p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-semibold text-gray-800">Resume (ATS · ats__ai)</p>
                  <a
